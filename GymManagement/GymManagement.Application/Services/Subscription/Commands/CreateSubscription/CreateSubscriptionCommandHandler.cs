...
public class CreateSubscriptionCommandHandler : IRequestHandler<CreateSubscriptionCommand, ErrorOr<Domain.Entities.Subscriptions.Subscription>>
{
    ...
    public async Task<ErrorOr<Domain.Entities.Subscriptions.Subscription>> Handle(CreateSubscriptionCommand request, CancellationToken cancellationToken)
    {
